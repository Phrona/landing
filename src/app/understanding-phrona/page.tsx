...
const MOVES = [
  ...
  },
  {
    ...
    title: "Monitor",
    body:
      "Phrona continuously monitors the external drivers that matter because of those convictions — competitors, markets, regulation, technology, customers, and capital.",
  },
  {
    n: "03",
    title: "Challenge",
  ...
  },
  {
    ...
    title: "Inform",
    body:
      "Phrona connects new data to your strategy, showing what is now at risk, what else may be affected, and where your attention is needed. The analysis is automated. The judgment remains yours.",
  },
];
        ...
        <div className="max-w-3xl mx-auto pt-16 sm:pt-24">
          ...
          <header className="mb-20">
            ...
            <p className="text-xl sm:text-2xl text-foreground leading-relaxed">
              Companies rarely fail due to poor planning. They fail because the
              world changes while the plan is being executed, and those at the
              helm continue steering by assumptions that used to be true but no
              longer are.
            </p>
          </header>
          ...
          <div className="space-y-6 text-lg text-muted-foreground leading-relaxed">
            ...
            <p>
              These aren’t facts. They’re strategic convictions, and every major
              decision depends on them. The problem isn’t that these convictions
              are wrong — it’s that they’re usually revisited only after
              disappointing results force the issue. By then, months — or even
              years’ worth — of decisions about product, people, and capital
              have compounded on assumptions that no longer reflect reality.
            </p>

            <p>
              There’s a name for this in navigation — where you estimate your
              current position based only on where you’ve been, without checking
            ...
            <p>
              ...
              the same way: they establish a direction and execute relentlessly,
              but no one checks whether they’re still on course. Dead reckoning
              fails because unmeasured drift from wind and current compounds
              over distance. It wrecked ships for centuries. It does the same to
              strategy.
            </p>

            <p>
              Every critical business function has infrastructure that keeps it
              connected to reality.
            </p>

            <p className="text-foreground">
              Finance has ERP. Sales has CRM. Engineering has Git. Manufacturing
              has MES.
            </p>
            ...
            <PullLine>Phrona provides the infrastructure strategy lacks.</PullLine>

            <p>
              Phrona continuously monitors the convictions your strategy depends
              on. It watches the external signals most likely to change them and
              alerts you when the world — and your understanding of it — have
              begun to diverge.
            </p>
          ...
          <div className="mt-24 pt-20 border-t border-border">
            ...
            <Q title="What is “infrastructure for strategy”?">
              ...
              <p>
                ...
                <span className="text-foreground font-medium">conviction</span>{" "}
                — a belief the company holds to be true.
              </p>

              <p>
                Every strategy depends on a handful of convictions. The problem:
                reality shifts; convictions rarely do.
              </p>

              <p>
                Every other critical business function has infrastructure to
                keep it grounded in reality — finance has ERP; sales has CRM;
                manufacturing has MES; engineering has Git. Each exists for the
                same reason: to ensure decisions are based on today’s reality,
                not yesterday’s.
              </p>
              ...
              <p>
                Organizations naturally spend more time executing strategy than
                revisiting the underlying convictions. The better a company gets
                at execution, the more dangerous stale convictions become.
              </p>
              ...
              <p className="text-foreground">
                The companies mentioned above? Fortescue. JCPenney. BlackBerry.
              </p>

              <p>
                Different industries, different strategies, one pattern: reality
                changed, convictions didn’t, and strategy never caught up.
              </p>
            ...
            <Q title="Why doesn’t infrastructure for strategy already exist?">
              <p className="text-foreground font-medium">It wasn’t practical.</p>

              <p>
                Until recently, markets evolved slowly, and strategy could be
                revisited periodically without falling behind reality. Even if
                you wanted your strategy to reflect the latest intel, it wasn’t
                practical. Doing so required constantly monitoring competitors,
                markets, regulation, technology, customers, and capital — and
                connecting those changes back to the specific convictions your
                strategy depended on. That required more sustained analysis than
                any leadership team could realistically maintain without a
                multi-million-dollar management consulting budget.
              </p>
              ...
              <p>
                Today, neither driver holds — reality moves faster than planning
                cycles can keep pace, and AI has made continuous strategic
                analysis economically practical.
              </p>
          ...
          <div className="mt-24 pt-20 border-t border-border">
            <Q title="Can’t Claude (or ChatGPT or Gemini) do the same thing?">
              ...
              <p>
                ...
                any understanding they develop disappears when the conversation
                ends.
              </p>
              <p>
                Phrona begins every conversation with your strategy as a living
                structure. It remembers the convictions your strategy depends
                on, continuously incorporates new information, and maintains a
                current understanding of your strategy and the world it operates
                in.
              </p>
              <PullLine>LLMs provide intelligence. Phrona provides continuity.</PullLine>
            </Q>
            ...
            <Q title="So it’s just competitive intelligence, then?">
              ...
              <p>
                ...
                technological breakthrough, or customer trend can be irrelevant
                to one company and existential to another. Its importance
                depends entirely on the convictions your strategy rests upon.
              </p>
              <p>
                Phrona doesn’t replace competitive intelligence — it integrates
                it, calibrating every signal against your strategy. The result
                is less noise, more relevance.
              </p>
            </Q>
            ...
            <Q title="Why not just hire a consultant?">
              ...
              <p>
                ...
                world continues to change after the engagement ends. A strategy
                fit for yesterday may not fit today. Phrona provides continuity
                between those moments, keeping you informed as the environment
                changes.
              </p>
            </Q>
            ...
            <Q title="Doesn’t my team already own this?">
              ...
              <p>
                Most teams spend their time executing strategy, not questioning
                the convictions underneath it. Phrona makes continuous strategic
          ...
          <div className="mt-24 pt-20 border-t border-border">
            <Q title="What changes when a company has infrastructure for strategy?">
              ...
              <p>
                ...
                <span className="italic">“What happened?”</span> after the fact,
                you start asking{" "}
            ...
            <Q title="Is Phrona just another system to maintain?">
              ...
              <p>
                Most of the work happens in the background — Phrona continuously
                gathers information, monitors competitors, tracks regulation,
                and — most importantly — connects the dots to show what it means
                for your strategy. It automates the analytical work, allowing
                you to focus on what technology cannot replace: judgment.
              </p>
              <p>
          ...
          <div className="mt-24 pt-20 border-t border-border">
            <Q title="What does Phrona deliver?">
              ...
              <p>
                When something meaningful changes, Phrona explains what changed,
                why it matters, what part of your strategy is affected, and the
                evidence behind its reasoning. It also provides recurring
                strategic briefings, and whenever you want to explore an issue
                more deeply, you can simply ask.
              </p>
              <p>
                As your model gains richness, so do the capabilities built on
                top of it — from continuously validating your strategy, to
                analyzing competitors through the same lens, to rehearsing major
                decisions before you commit capital.
              </p>
              <p className="text-foreground">
            ...
            <Q title="Who is Phrona for?">
              ...
              <p>
                ...
                markets, launching new products, scaling rapidly, or betting on
                long-term technological shifts all depend on a handful of
            ...
            <Q title="What is the Founding Cohort?">
              ...
              <p>
                ...
                something we want to do with a handful of exceptional companies.
              </p>
            </Q>
